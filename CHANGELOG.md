...
* docs: add Buy Me a Coffee sponsor link by @jeffersongoncalves in https://github.com/jeffersongoncalves/filament-gtm/pull/16
* chore: add GitHub Sponsors to FUNDING.yml by @jeffersongoncalves in https://github.com/jeffersongoncalves/filament-gtm/pull/19
* ci: standardize update-changelog workflow (3.x) by @jeffersongoncalves in https://github.com/jeffersongoncalves/filament-gtm/pull/25
* ci: standardize dependabot config by @jeffersongoncalves in https://github.com/jeffersongoncalves/filament-gtm/pull/26
* ci: standardize dependabot config by @jeffersongoncalves in https://github.com/jeffersongoncalves/filament-gtm/pull/32
* build(deps): update jeffersongoncalves/laravel-gtm requirement from ^2.0 to ^3.0 in the composer-deps group by @dependabot[bot] in https://github.com/jeffersongoncalves/filament-gtm/pull/31
* feat(i18n): add translations (3.x) by @jeffersongoncalves in https://github.com/jeffersongoncalves/filament-gtm/pull/37

**Full Changelog**: https://github.com/jeffersongoncalves/filament-gtm/compare/3.2.0...3.3.0
...
- GtmPlugin class with fluent API (`settingsPage`)
- ManageGtmSettings page powered by `spatie/laravel-settings`
- Translations (en, pt_BR) for navigation, titles, and fields
- `filament/spatie-laravel-settings-plugin` `^5.0` dependency

### Changed

- Updated `jeffersongoncalves/laravel-gtm` from `^1.0` to `^2.0`

**Full Changelog**: https://github.com/jeffersongoncalves/filament-gtm/compare/3.0.0...3.1.0
