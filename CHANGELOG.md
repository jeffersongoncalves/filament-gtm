...
* docs: add Buy Me a Coffee sponsor link by @jeffersongoncalves in https://github.com/jeffersongoncalves/filament-gtm/pull/18
* chore: add Buy Me a Coffee to FUNDING.yml by @jeffersongoncalves in https://github.com/jeffersongoncalves/filament-gtm/pull/21
* ci: standardize update-changelog workflow (2.x) by @jeffersongoncalves in https://github.com/jeffersongoncalves/filament-gtm/pull/24
* build(deps): bump the actions-deps group with 2 updates by @dependabot[bot] in https://github.com/jeffersongoncalves/filament-gtm/pull/28
* build(deps): update jeffersongoncalves/laravel-gtm requirement from ^2.0 to ^3.0 in the composer-deps group by @dependabot[bot] in https://github.com/jeffersongoncalves/filament-gtm/pull/33
* feat(i18n): add translations (2.x) by @jeffersongoncalves in https://github.com/jeffersongoncalves/filament-gtm/pull/36

**Full Changelog**: https://github.com/jeffersongoncalves/filament-gtm/compare/2.2.0...2.3.0
...
- `filament/spatie-laravel-settings-plugin` `^4.0` dependency

### Changed

- Updated `jeffersongoncalves/laravel-gtm` from `^1.0` to `^2.0`

**Full Changelog**: https://github.com/jeffersongoncalves/filament-gtm/compare/2.0.0...2.1.0
